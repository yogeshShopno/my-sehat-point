  ...
  return (
    ...
    >
      ...
      <div className="container relative grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
        ...
        <div className="lg:col-span-5 relative animate-fade-in-right" style={{ animationDelay: "0.2s" }}>
          <div className="relative">
            ...
            {/* Floating cards */}
            <div className="hidden sm:flex absolute -bottom-5 -left-5 lg:-left-10 items-center gap-3 bg-white/95 backdrop-blur rounded-2xl p-3.5 shadow-elegant text-foreground ">
            ...
            <div
              className="hidden sm:flex absolute -top-5 -right-5 lg:-right-8 items-center gap-3 bg-white/95 backdrop-blur rounded-2xl p-3.5 shadow-elegant text-foreground "
      ...
      <div className="relative mt-20 md:mt-24 border-y border-white/10 bg-white/[0.03] backdrop-blur-sm overflow-hidden">
        <div className="flex animate-marquee whitespace-nowrap py-4 gap-12 text-sm md:text-base font-display font-semibold text-white/70 [animation-duration:12s] md:[animation-duration:25s]">
